...
class BinanceOHLCV(Base):
    """Candlestick / OHLCV data per symbol + interval."""

    __tablename__ = "binance_ohlcv"
    __table_args__ = (
        UniqueConstraint("symbol", "interval", "open_time", name="uq_binance_ohlcv_symbol_interval_open"),
    )
    ...
    # Internal Binance kline id for deduplication
